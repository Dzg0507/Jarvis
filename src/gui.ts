...
function setupSettingsEventListeners() {
    ...
    const resetSettingsBtn = settingsScreen.querySelector('#reset-settings-btn') as HTMLButtonElement;
    ...
    themeOptions.forEach(option => {
        (option as HTMLButtonElement).onclick = () => {
            themeOptions.forEach(opt => opt.classList.remove('active'));
            option.classList.add('active');
            // Theme switching logic would go here
            console.log('GUI: Theme changed to', (option as HTMLElement).dataset.theme);
        };
    });
